  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <form
        ...
        className="bg-base-200 rounded-lg w-screen h-screen sm:w-auto sm:h-auto py-10 px-5 shadow-md">
        <p className=" text-2xl font-bold text-center mb-10">
            Iniciar {""}
            <span className=" text-info font-bold">Sesión</span>
        </p>
        ...
        <div className="mb-5">
          <label
            htmlFor="email"
            className="bloc font-bold uppercase"
          >
            Email
          </label>
          <input
